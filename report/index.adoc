...
image::Images/Architecture.png["System Architecture Diagram", align="center", width="70%, height="70%"]
...
.Onion Overview
image::Images/Minitwit-Git-Truck.png["Onion Architecture Diagram", align="center", width="70%, height="70%"]
...
image::Images/SequenceDiagramPublicTimelineMinitwit.png[]["Simulator Request Sequence Diagram", align="center", width="70%, height="70%"]
...
image::Images/QualityGate.png["Static Analysis results", align="center", width="70%, height="70%"]
...
image::Images/WorkflowDiagram.jpg["CD chain", align="center", width="70%, height="70%"]
...
.Grafana Dashboard
image::Images/GrafanaDashboard.png["Grafana dashboard", align="center", width="70%, height="70%"]
...
* Asynchronous actions where not awaited
* 
