...
The system architecture depicted in figure 1 represents the entire system from source code on a development machine to the deployed solution on virtual containers and everything in between.
...
image::Images/SequenceDiagramPublicTimelineMinitwit.png[]["Simulator Request Sequence Diagram", align="center", width="70%]
