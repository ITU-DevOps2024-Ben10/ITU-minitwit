...
These scaling issues were not related to vertical scaling, but were fundamental flaws in the code.
...
It became obvious that horizontal and vertical scaling cannot always be used to mitigate performance related issues. Sometimes
