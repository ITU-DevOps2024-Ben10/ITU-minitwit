...
The effects from learning Scrum seeped into the working style of the team, not by introducing scrum events and the like, but using the 3 pillars of Scrum; Adaptation, Transparency, and Inspection <<ref_scrum_guide>> as guideline. Each friday the team held physical meetings, where the state of the project was discussed, keeping each member up to date while answering questions any member might have. Breaking down the work each week, increased understanding of the project, transparency, and ensured openness amongst the team. Github allowed for fine-grained inspection of source code, through peer-reviewed code inspections in the form of "Pullrequest". 

In the same way the agile principles were introduced to the project. Of the twelve principles; "Welcome changing requirements", was the most prevalent as new requirements were added almost weekly. Even so within those requirements, there where options
